# -----------------------------------------------
# Data sources — look up hub VPC and firewall subnet
# -----------------------------------------------
...
# -----------------------------------------------
# Stateful Rule Group
# Deep packet inspection — blocks known bad domains
# -----------------------------------------------

resource "aws_networkfirewall_rule_group" "stateful" {
  name     = "lab-stateful-rules"
  type     = "STATEFUL"
  capacity = 100
...
# -----------------------------------------------
# Network Firewall — deployed in hub firewall subnet
# -----------------------------------------------
